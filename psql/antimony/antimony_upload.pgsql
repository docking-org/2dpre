    ...
    begin
        case
            when stage = 1 then
                ...
                execute(format('insert into transaction_records_%s (stagei, parti, nnew, nupload) (values (1, %s, %s, %s))', transid, part, nnew, nupload));
            ...
            when stage = 2 then
                ...
                execute(format('insert into transaction_records_%s (stagei, parti, nnew, nupload) (values (2, %s, %s, %s))', transid, part, nnew, nupload));
