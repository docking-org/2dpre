...
for partition in $(cat /dev/shm/partitions_to_postgres.txt); do
	...
	jobid=$(sbatch --parsable --priority=TOP --cpus-per-task=5 -w $slurmhost -o $logdir/psql_$slurmhost/2dpsql_${partid}_${port}_${imageid}.out -J 2dpsqlx $BINDIR/2dload_slurm.bash postgres $partid $UPLOAD_OPTION)
